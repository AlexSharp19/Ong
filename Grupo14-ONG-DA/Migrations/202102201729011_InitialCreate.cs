    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TypeMultimediaFiles", t => t.TypeFile_Id)
                .Index(t => t.TypeFile_Id);
            
            CreateTable(
                "dbo.TypeMultimediaFiles",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TypeMultimedia = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MultiMedias", "TypeFile_Id", "dbo.TypeMultimediaFiles");
            ...
            DropIndex("dbo.MultiMedias", new[] { "TypeFile_Id" });
            ...
            DropTable("dbo.TypeMultimediaFiles");
